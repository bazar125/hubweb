...
import CustomActions from '@/components/Vuetable/CustomActions';
import FilterBar from '@/components/Vuetable/FilterBar';
import CssConfig from '@/components/Vuetable/VuetableCssConfig';
